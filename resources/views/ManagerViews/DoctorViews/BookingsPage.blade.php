...
<body>
    <div class="topnav1">
        ...
        <a class="active" href="/doctor/bookings">Bookings</a>
    ...
    @foreach ($bookings as $booking)
        <div class="form-holder" id="{{ $booking->id }}">
            <form class="w3-panel w3-card-4 addUserForm" action="/doctor/edit-booking" method="post"
                ...
                <div class="w3-section">
                    ...
                    <label>{{ $currentdoctor->name }}</label>
                </div>
                <div class="w3-section">
                    <label>Date:</label>
                    @php
                ...
                <div class="w3-section">
                    <label>Details:</label>
                    <input class="w3-input w3-hover-grey" type="text" name="details"value="{{ $booking->details }}">
                </div>
                <div class="w3-section">
                    <label>Status:</label>
                    <input class="w3-input w3-hover-grey" type="text" name="status"value="{{ $booking->status }}">
                </div>
                <div class="w3-section">
                    <label>File:</label>
    ...
    <div class="w3-container">
        ...
        <div style="margin: 10px 0 0 0 !important;">
            <form id="search-box" class="search-box" action="/doctor/search-booking" method="get">
