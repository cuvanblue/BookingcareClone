...
<body>
    <div class="topnav1">
        ...
        <a class="active" href="/admin/schedules">Schedules</a>
    ...
    <div class="form-holder" id="add-schedule-form">
        <form class="w3-panel w3-card-4 addUserForm" action="/admin/add-schedule" method="post">
            {{ csrf_field() }}
    ...
    @foreach ($schedules as $schedule)
        <div class="form-holder" id="{{ $schedule->id }}">
            <form class="w3-panel w3-card-4 addUserForm" action="/admin/edit-schedule" method="post"
    ...
    <div class="w3-container">
        ...
        <div style="margin: 10px 0 0 0 !important;">
            ...
            <form id="search-box" class="search-box" action="/admin/search-schedule" method="get">
                ...
                @foreach ($schedules as $schedule)
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="submit" onclick="Delete({{ $schedule->id }},'/admin/delete-schedule')"
                                class="w3-btn w3-white w3-border w3-border-green"
                                style="color: #04AA6D !important;
