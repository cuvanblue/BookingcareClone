...
<body>
    <div class="topnav1">
        ...
        <a class="active" href="/clinic/bookings">Bookings</a>
    ...
    <div class="form-holder" id="add-booking-form">
        <form class="w3-panel w3-card-4 addUserForm" action="/clinic/add-booking" method="post">
            {{ csrf_field() }}
    ...
    @foreach ($bookings as $booking)
        <div class="form-holder" id="{{ $booking->id }}">
            <form class="w3-panel w3-card-4 addUserForm" action="/clinic/edit-booking" method="post"
    ...
    <div class="w3-container">
        ...
        <div style="margin: 10px 0 0 0 !important;">
            ...
            <form id="search-box" class="search-box" action="/clinic/search-booking" method="get">
                ...
                @foreach ($bookings as $booking)
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="submit" onclick="Delete({{ $booking->id }},'/clinic/delete-booking')"
                                class="w3-btn w3-white w3-border w3-border-green"
                                style="color: #04AA6D !important;
