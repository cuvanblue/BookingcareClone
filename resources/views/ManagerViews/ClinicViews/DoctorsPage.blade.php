...
<body>
    <div class="topnav1">
        ...
        <a class="active" href="/clinic/doctors">Doctors</a>
    ...
    <div class="form-holder" id="add-doctor-form">
        <form class="w3-panel w3-card-4 addUserForm" action="/clinic/add-doctor" method="post">
            {{ csrf_field() }}
            ...
            <div class="w3-section" style="display: none;">
                ...
                <input class="w3-input w3-hover-grey" type="number" name="clinicid" value="{{ $currentclinic->id }}">
            </div>
            <div class="w3-section">
                <label>Career:</label>
    ...
    @foreach ($doctors as $doctor)
        <div class="form-holder" id="{{ $doctor->id }}">
            <form class="w3-panel w3-card-4 addUserForm" action="/clinic/edit-doctor" method="post"
    ...
    <div class="w3-container">
        ...
        <div style="margin: 10px 0 0 0 !important;">
            ...
            <form id="search-box" class="search-box" action="/clinic/search-doctor" method="get">
                ...
                @foreach ($doctors as $doctor)
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="submit" onclick="Delete({{ $doctor->id }},'/clinic/delete-doctor')"
                                class="w3-btn w3-white w3-border w3-border-green"
                                style="color: #04AA6D !important;
